...
const char *enemy_pos_to_string(wall_pos_e pos)
{
    switch (pos) {
    case WALL_POS_NONE:
        return "NONE";
    case WALL_POS_FRONT_LEFT:
        return "FRONT_LEFT";
    case WALL_POS_FRONT:
        return "FRONT";
    case WALL_POS_FRONT_RIGHT:
        return "FRONT_RIGHT";
    case WALL_POS_FRONT_AND_FRONT_LEFT:
        return "FRONT_AND_FRONT_LEFT";
    case WALL_POS_FRONT_AND_FRONT_RIGHT:
        return "FRONT_AND_FRONT_RIGHT";
    case WALL_POS_FRONT_ALL:
        return "FRONT_ALL";
    case WALL_POS_LEFT_RIGHT:
        return "Left and right";
    }
    return "";
}

const char *enemy_range_to_string(wall_range_e range)
{
    switch (range) {
    case WALL_RANGE_NONE:
        return "NONE";
    case WALL_RANGE_CLOSE:
        return "CLOSE";
    case WALL_RANGE_MID:
        return "MID";
    case WALL_RANGE_FAR:
